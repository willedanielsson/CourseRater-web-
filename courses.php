...
?>
	<div id="course_selection">
		...
		<div class="course_div" id="input">
			...
			<div class="input_holder">
				...
				<select id="select_country" ng-model="model_selectedCountry" ng-change="getUniversities(model_selectedCountry)">
			...
			<div class="input_holder">
				...
				<select id="select_university" ng-model="model_selectedUniversity" ng-style=styleSelectUniversity ng-change="getCourses(model_selectedUniversity)" >
	...
	<div id="course_information" ng-switch on="page">
		...
		<div class="switch" ng-switch-when="def">
			<!-- Empty Div is default-->
		</div>

		<div class="switch" id="course_rating" ng-switch-when="view">
			<h1>{{course}}</h1>
			<p class="general_rating">{{generalRating}}

		

			<div id="add_review_button">
				<a class="button" ng-click="addReview(model_course_input, model_selectedUniversity)">Add Review</a>
			</div>
...
<!-- Exam -->
				<li id="exam_rating" ng-style="exam_style" ng-click="getComments(toggle_exam=!toggle_exam, 'exam')">
					<div class="course_information_list_item_container">	
						<div class="part">
							<p>Exam</p>
						</div>
...
<!-- Lecture -->			
			<li id="lecture_rating" ng-style="lecture_style" ng-click="getComments(toggle_lecture=!toggle_lecture, 'lectures')">
			<div class="course_information_list_item_container">	
				<div class="part">
					<p>Lectures</p>
				</div>
			...
			<li id="lesson_rating" ng-style="lesson_style" ng-click="getComments(toggle_lesson=!toggle_lesson)">
			<div class="course_information_list_item_container">	
				<div class="part">
					<p>Lessons</p>
				</div>
			...
			<li id="laboratory_rating" ng-style="laboratory_style" ng-click="getComments(toggle_lab=!toggle_lab)">
			<div class="course_information_list_item_container">
				<div class="part">
					<p>Laboratory</p>
				</div>
			...
			<li id="seminar_rating" ng-style="seminar_style" ng-click="getComments(toggle_seminar=!toggle_seminar)">
			<div class="course_information_list_item_container">
				<div class="part">
					<p>Seminar</p>
				</div>
			...
			<li id="project_rating" ng-style="project_style" ng-click="getComments(toggle_project=!toggle_project)">
			<div class="course_information_list_item_container">
				<div class="part">
					<p>Project</p>
				</div>
			...
			<li id="homeassignment_rating" ng-style="homeassignment_style" ng-click="getComments(toggle_home=!toggle_home)">
			<div class="course_information_list_item_container">
				<div class="part">
					<p>Homeassignment</p>
				</div>
			...
			<li id="case_rating" ng-style="case_style" ng-click="getComments(toggle_case=!toggle_case)">
			<div class="course_information_list_item_container">
				<div class="part">
					<p>Case</p>
				</div>
...
<!----------------------- ADD REVIEW  -------------------------------->
		<div id="add_review" ng-switch-when="addReview" ng-controller="rateCourseController">
			...
			<div class="form_div" id="form_div_review">
				...
				<input type="submit" ng-click="submitReview(ratings)" class="button" id="add_review_form_button" value="Add"/>
				</form>
				
				<div class="error_message" id="add_review_message">
					<p ng-bind="message_review"></p>
				</div>
